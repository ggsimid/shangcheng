                    ...
                    <el-col :span="24">
                        <div class="topbg">
                            <el-row>
                                <el-col :span="1">
                                    <!-- 控制菜单的展开和收缩图标 -->
                                    <!--showhide方法点击或隐藏左边菜单栏，思路：点击改变数据，然后数据控制这左边菜单栏的样式 -->
...
<script>
    export default {
        ...
        methods: {
            showhide() {
                //    1.0控制菜单的展开和收缩。菜单关联属性iscollapse，被这个方法控制住。
                this.iscollapse = !this.iscollapse;

                //    2.0 当菜单是收缩状态的时候，leftcol等于1 rightcol=23。这个2个属性控制这饿了么UI框架左右布局中的span值！！
                if (this.iscollapse) {
                    this.leftcol = 1;
                    this.rightcol = 23;
